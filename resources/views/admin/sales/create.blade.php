<x-layouts::admin>
    ...
    <section class="grid grid-cols-2 gap-4 mb-5">
        ...
        <div class="bg-white rounded-lg shadow-md p-4 border-2 border-t-emerald-600 flex flex-col max-h-[85vh]">
            <form action="{{ route('admin.sales.store') }}" method="POST" class="flex flex-col flex-1 min-h-0">
                @csrf
                ...
                <div class="mt-auto pt-3 border-t border-gray-200 flex flex-col gap-3">
                    ...
                    <div class="flex flex-col sm:flex-row items-end sm:items-center justify-between gap-3 pt-2">
                        ...
                        <div class="w-full sm:w-auto">
                            <label for="sale_date" class="block text-xs font-semibold text-gray-600 mb-1">
                                Fecha de Venta
                            </label>
                    ...
                    <tbody class="bg-white">
                        @forelse ($products as $product)
                            <tr class="bg-neutral-primary border-b border-default">
                                ...
                                <td class="px-6 py-4">
                                    <button type="button"
                                        class="text-white {{ $product->stock <= 0 ? 'bg-red-600 border-red-700' : 'bg-emerald-600 border-brand hover:bg-emerald-700' }} font-medium rounded-sm text-xs px-2 py-1.5 btn-add-product disabled:opacity-50 disabled:cursor-not-allowed"
