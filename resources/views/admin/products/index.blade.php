<x-layouts::admin>
    ...
    <section class="relative bg-white shadow-md rounded-lg mb-5">
        <div class="items-center justify-between p-4 flex space-y-0 space-x-4">
            <div>
                <h5 class="mr-3 font-semibold">Productos</h5>
                            ...
                            <tr class="bg-neutral-primary border-b border-default">
                                ...
                                <td class="px-6 py-4">
                                    <div class="inline-flex rounded-lg shadow-xs -space-x-px" role="group">
                                        <a href="{{ route('admin.products.edit', $product) }}" class="bg-yellow-500 p-1 rounded-l-lg">Editar</a>
                                        <form action="{{ route('admin.products.destroy', $product) }}" method="POST" class="delete-form bg-red-500 p-1 rounded-e-lg text-white">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit">
                                                Eliminar
